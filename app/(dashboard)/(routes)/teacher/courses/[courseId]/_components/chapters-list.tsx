                ...
                {(provided) => (
                  <div
                    className={`flex items-center gap-x-2 bg-gray-200 border-gray-200 border text-gray-700 rounded-md mb-4 text-sm
                      ${chapter.is_published && "bg-blue-100 border-blue-200 text-blue-700"}
                      dark:bg-slate-700 dark:border-slate-600 dark:text-slate-300
                      dark:${chapter.is_published && "bg-blue-800 border-blue-600 text-blue-300"}
                    `}
                  ...
                  >
                    <div
                      className={`px-2 py-3 border-r border-r-gray-200 hover:bg-gray-300 rounded-l-md transition
                        ${chapter.is_published && "border-r-blue-200 hover:bg-blue-200"}
                        dark:border-r-slate-800 dark:hover:bg-slate-700
                        dark:${chapter.is_published && "border-r-blue-600 hover:bg-blue-800"}
                      `}
                    ...
                    <div className="ml-auto pr-2 flex items-center gap-x-2">
                      ...
                      <Badge
                        className={`bg-gray-500
                          ...
                          dark:bg-slate-500
                          dark:${chapter.is_published && "bg-sky-700"}
                        `}
                      >
