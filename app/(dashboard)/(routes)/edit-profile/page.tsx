...
import { ArrowLeft, ArrowRight, Camera, ChevronDown, Edit, Eye, EyeOff } from "lucide-react";
...
export default function EditProfile() {
    ...
    const [showPasswordFields, setShowPasswordFields] = useState(false); // New state for dropdown
    ...
    useEffect(() => {
        const fetchProfileData = async () => {
            try {
                ...
                setVipStatus(profileData.vip || "لا يوجد VIP");
                setEmail(user.email || "");
